...
class Inventory: def init(self, capacity=30): self.slots = { "głowa": EquipmentSlot("głowa"), "tors": EquipmentSlot("tors"), "nogi": EquipmentSlot("nogi"), "buty": EquipmentSlot("buty"), "broń": EquipmentSlot("broń"), "tarcza": EquipmentSlot("tarcza"), "pierścień1": EquipmentSlot("pierścień1"), "pierścień2": EquipmentSlot("pierścień2") } self.items = [] self.capacity = capacity
